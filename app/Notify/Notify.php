...
class Notify {
    ...
    protected function notifyMethods($sendVia = null) {
        ...
        if ($this->templateName == 'SEND_LIVE_EXAM_CODE' || $this->templateName == 'SEND_LIVE_EXAM' || $this->templateName == 'SEND_NEW_CONTEST' || $this->templateName == 'SEND_NEW_DAILY_QUIZ' || $this->templateName == 'SEND_NEW_FUN' || $this->templateName == 'PROMOTIONAL_NOTIFY') {
            $methods['push_notification'] = PushNotification::class;
        }
