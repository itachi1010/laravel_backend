...
function notify($user, $templateName, $shortCodes = null, $sendVia = null, $createLog = true, $clickValue = null, $image = null)
{
    $general          = gs();
    $globalShortCodes = [
...
function levelStatus($data)
{
    $prev = null;
    foreach ($data->quizInfos as $key => $quizInfo) {
        if ($key == 0) {
...
function importFileReader($file, $columns, $uniqueColumns = [], $dataInsert = true, $modelClass = Question::class)
{
