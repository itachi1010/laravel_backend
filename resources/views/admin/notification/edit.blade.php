                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('Status') <span class="text-danger">*</span></label>
                                    <input type="checkbox" data-height="46px" data-width="100%" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Send')"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('Message')</label>
                                    <textarea name="push_notification_body" rows="10" class="form-control" placeholder="@lang('Your message using short-codes')">{{ $template->push_notification_body }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
