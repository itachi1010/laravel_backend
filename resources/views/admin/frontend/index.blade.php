                                                        ...
                                                        <div class="thumb">
                                                            ...
                                                            <div class="avatar-edit">
                                                                <input class="profilePicUpload"
                                                                    ...
                                                                    name="image_input[{{ @$imgKey }}]" type="file"
                                                                    accept=".png, .jpg, .jpeg">
                                                                <label class="bg--primary"
                                                                    for="profilePicUpload{{ $loop->index }}">{{ __(keyToTitle(@$imgKey)) }}</label>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input class="form-control iconPicker icon"
                                                                name="{{ $k }}" type="text"
                                                                value="{{ $content->data_values->$k }}" autocomplete="off"
                                                                required>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="{{ $k }}"
                                                            type="text" value="{{ @$content->data_values->$k }}"
                                                            required />
                                                    </div>
                                                </div>
                                            @endif
                                                ...
                                                <div class="button--group">
                                                    ...
                                                    @else
                                                        <a class="btn btn-sm btn-outline--primary"
                                                            href="{{ route('admin.frontend.sections.element', [$key, $data->id]) }}"><i
                                ...
                                @if ($k != 'modal')
                                    @if ($type == 'icon')
                                        <div class="form-group">
                                            <label>{{ __(keyToTitle($k)) }}</label>
                                            <div class="input-group">
                                                <input class="form-control iconPicker icon" name="{{ $k }}"
                                                    ...
                                                    <div class="thumb">
                                                        ...
                                                        <div class="avatar-edit">
                                                            ...
                                                            <label class="bg--success"
                                                                for="addImage{{ $loop->index }}">{{ __(keyToTitle($imgKey)) }}</label>
                                                            <small class="mt-2">@lang('Supported files'):
                                                                <b>@lang('jpeg'), @lang('jpg'),
                                                                    @lang('png')</b>.
        ...
        <div class="modal fade" id="updateBtn" role="dialog" tabindex="-1">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="edit-route" action="{{ route('admin.frontend.sections.content', $key) }}"
                                                    ...
                                                    <div class="thumb">
                                                        ...
                                                        <div class="avatar-edit">
                                                            <input class="profilePicUpload"
                                                                ...
                                                                accept=".png, .jpg, .jpeg">
                                                            <label class="bg--success"
                                                                for="fileUploader{{ $loop->index }}">{{ __(keyToTitle($imgKey)) }}</label>
                                                            <small class="mt-2">@lang('Supported files'):
                                                                <b>@lang('jpeg'), @lang('jpg'),
                                                                    @lang('png')</b>.
                                                                @if (@$section->element->images->$imgKey->size)
...
<div class="d-flex justify-content-end flex-wrap">
    ...
    @if (@$section->element)
        @if ($section->element->modal)
            <a class="btn btn-sm btn-outline--primary addBtn h-45 ms-2 d-flex align-items-center justify-content-center" href="javascript:void(0)">
                <i class="las la-plus"></i>
                @lang('Add New')
            </a>
        @else
            <a class="btn btn-sm btn-outline--primary h-45 ms-2 d-flex align-items-center justify-content-center" href="{{ route('admin.frontend.sections.element', $key) }}">
                <i class="las la-plus"></i>
                @lang('Add New')
            </a>
        @endif
